#!/bin/bash  # tells the shell what  shell to run the script under, here bash shell.  
MAXCORE=16  # MAXCORE = 16 : Number of cores per socket as accordance with foseres system. You are putting here the number of cores of 1 socket of the processor that I am using and that should generate all the runs I can think.  
NSOCKETS=2  
NODES=$1
localt=(4 6 8 10)
locall=6
