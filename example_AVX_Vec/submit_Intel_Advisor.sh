...
advisor -collect=survey --project-dir=./advi_results2 ./avx_complex_vec_align_load_bench
#advisor --collect=tripcounts --flop --enable-cache-simulation --project-dir=./advi_results2  ./avx_complex_vec_align_load_bench
#advisor -c=roofline --project-dir=./advi_results2 ./avx_complex_vec_align_load_bench 
